...
/**
 * Shared icon set. One consistent grid (24×24), stroke width, and line joins
 * across the whole app so icons read as a single family. Icons are decorative
 * by default (`aria-hidden`); the interactive element that wraps them carries
